...
public class PqrsService {
    ...
    public void RegistrarPqrs(PQRS pqrs) {
        String sql = "INSERT INTO pqrs (tipoComentario, descripcion, idComun) VALUES (?, ?, ?)";
        ...
        try (Connection conn = DataBase.conectar();
            ...
            pstmt.setInt(3, pqrs.getIdComun()); // Usamos el idComun directamente
    ...
    public void ImprimirPqrs() {
        ...
        try (Connection conn = DataBase.conectar();
            ...
            while (rs.next()) {
                ...
                System.out.println("ID Cliente: " + rs.getInt("idComun"));
                System.out.println("------------------------------------------------------");
            }
